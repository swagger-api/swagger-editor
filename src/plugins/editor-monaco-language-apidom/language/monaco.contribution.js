  ...
  globalThis.MonacoEnvironment = {
    ...
    getWorkerUrl(moduleId, label) {
      if (label === apidom.languageId) {
        return new URL(import.meta.env.VITE_APIDOM_WORKER_FILENAME, this.baseUrl).toString();
      }
      return new URL(import.meta.env.VITE_EDITOR_WORKER_FILENAME, this.baseUrl).toString();
    },
  };
};
