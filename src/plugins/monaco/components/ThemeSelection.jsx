  ...
  render() {
    ...
    return (
      <div>
        ...
        <button type="button" className="btn btn-theme-icon" onClick={() => onChange('my-vs-dark')}>
          swagger-dark
        </button>
        <button type="button" className="btn btn-theme-icon" onClick={() => onChange('vs-light')}>
          vs-light
        </button>
        <button type="button" className="btn btn-theme-icon" onClick={() => onChange('vs-dark')}>
          vs-dark
        </button>
      </div>
    );
